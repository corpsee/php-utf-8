 ...
 */
function is_word_chars ($str)
{
	return !(bool)preg_match(specials_pattern(), $str);
}
 ...
 */
function strip_specials ($string, $repl = '')
{
	return preg_replace(specials_pattern(), $repl, $string);
}
