...
class Utf8SubstrReplaceTest extends PHPUnit_Framework_TestCase
{
    public function test_replace_start()
    {
        ...
        $replaced = 'IñtërnâtX';
        $this->assertEquals($replaced, utf8\sub_replace($str, 'X', 8));
    }
    ...
    public function test_negative()
    {
        ...
        $this->assertEquals($replaced, utf8\sub_replace($str, 'foo', -2, -2));
    }
    ...
    public function test_zero()
    {
        ...
        $this->assertEquals($replaced, utf8\sub_replace($str, 'foo', 0, 0));
    }
    ...
    public function test_linefeed()
    {
        $str = "Iñ\ntërnâtiônàlizætiøn";
        $replaced = "Iñ\ntërnâtX";
        $this->assertEquals($replaced, utf8\sub_replace($str, 'X', 9));
    }
    ...
    public function test_linefeed_replace()
    {
        $str = "Iñ\ntërnâtiônàlizætiøn";
        $replaced = "Iñ\ntërnâtX\nY";
        $this->assertEquals($replaced, utf8\sub_replace($str, "X\nY", 9));
    }
}
