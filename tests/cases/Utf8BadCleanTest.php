...
class Utf8BadCleanTest extends PHPUnit_Framework_TestCase
{
	public function test_valid_utf8()
	{
		...
		$this->assertEquals($str, utf8_bad_clean($str));
	}
	...
	public function test_invalid_utf8()
	{
		...
		$this->assertEquals('Iñtërnâtiônàlizætiøn', utf8_bad_clean($str));
	}

	public function test_invalid_utf8_ascii()
	{
		$str = "this is an invalid char '\xe9' here";
		$this->assertEquals("this is an invalid char '' here", utf8_bad_clean($str));
	}
	...
	public function test_invalid_two_octet_sequence()
	{
		...
		$this->assertEquals($stripped, utf8_bad_clean($str));
	}
	...
	{
		$str = "Iñtërnâtiôn\xe9àlizætiøn";
		$this->assertEquals('Iñtërnâtiôn?àlizætiøn', utf8_bad_clean($str, '?'));
	}

	public function test_invalid_utf8_with_x_replace()
	{
		$str = "Iñtërnâtiôn\xe9àlizætiøn";
		$this->assertEquals('IñtërnâtiônXàlizætiøn', utf8_bad_clean($str, 'X'));
	}
	...
	public function test_invalid_two_octet_sequence_replace()
	{
		...
		$this->assertEquals($replaced, utf8_bad_clean($str, '?'));
	}
